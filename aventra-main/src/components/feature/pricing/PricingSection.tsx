              ...
              const testimonialItems = [
                {
                  ...
                  quote: storiesRaw?.story1?.quote || "Improved my ATS score from 64 to 92 in just two applications. Landed my dream job at a top tech company.",
                  type: storiesRaw?.story1?.type || "Job Seeker",
                  avatar: "SM",
                  score: 92,
                },
                {
                  name: storiesRaw?.story2?.name || "TechCorp Inc.",
                  role: storiesRaw?.story2?.role || "Hiring Manager",
                  quote: storiesRaw?.story2?.quote || "Reduced our screening time by 70%. Found qualified candidates 3x faster with AI-powered matching.",
                  type: storiesRaw?.story2?.type || "Company",
                  avatar: "TC",
                  score: null,
                },
                {
                  name: storiesRaw?.story3?.name || "Ahmed K.",
                  role: storiesRaw?.story3?.role || "UX Designer",
                  quote: storiesRaw?.story3?.quote || "The detailed breakdown showed exactly what to fix. My resume now passes every ATS system.",
                  type: storiesRaw?.story3?.type || "Job Seeker",
                  avatar: "AK",
                  score: 88,
                },
              ];
              return testimonialItems.map((story) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="flex size-12 items-center justify-center rounded-full bg-linear-to-br from-primary to-sky text-sm font-bold text-primary-foreground">
                      {story.avatar}
                    </span>
                    <div>
